        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm px-4 py-2 relative">
          <div className="max-w-7xl mx-auto flex items-center justify-center text-center">
            <p className="flex items-center gap-2">
              ...
              <a href={promotionData.link} className="underline font-semibold hover:no-underline">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <NavButton to="/login" variant="text">Log In</NavButton>
              <NavButton to="/register" variant="primary">Sign Up</NavButton>
            </div>
